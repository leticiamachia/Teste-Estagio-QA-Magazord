...
| CT-001   | Validar nome com letras e espaços    | Garantir que o campo aceite credenciais válidas (letras e espaços). | Usuário na tela de cadastro    | 1. Clicar no campo Nome<br>2. Inserir “Maria Silva de Oliveira”<br>3. Clicar em Salvar | Cadastro aceito sem erros e dados gravados no banco de dados |
...
| CT-005   | Validar nome em letras minúsculas    | Garantir que o sistema aceite nomes escritos apenas em minúsculas. | Usuário na tela de cadastro | 1. Clicar no campo Nome<br>2. Inserir “maria silva de oliveira”<br>3. Clicar em Salvar | Cadastro aceito sem erros; sistema pode ajustar para maiúsculas/minúsculas |
| CT-006   | Validar nome em letras maiúsculas    | Garantir que o sistema aceite nomes escritos apenas em maiúsculas. | Usuário na tela de cadastro | 1. Clicar no campo Nome<br>2. Inserir “MARIA SILVA DE OLIVEIRA”<br>3. Clicar em Salvar | Cadastro aceito sem erros; sistema pode ajustar para maiúsculas/minúsculas |
